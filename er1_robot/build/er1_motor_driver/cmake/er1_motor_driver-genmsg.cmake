...
### Generating Messages
_generate_msg_eus(er1_motor_driver
  "/home/arvind/clover_hack_day/er1_robot/src/er1_motor_driver/msg/Motors.msg"
  "${MSG_I_FLAGS}"
  ""
...
add_custom_target(er1_motor_driver_generate_messages_eus
  DEPENDS ${ALL_GEN_OUTPUT_FILES_eus}
)
add_dependencies(er1_motor_driver_generate_messages er1_motor_driver_generate_messages_eus)
...
# target for backward compatibility
add_custom_target(er1_motor_driver_geneus)
add_dependencies(er1_motor_driver_geneus er1_motor_driver_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS er1_motor_driver_generate_messages_eus)
...
if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/er1_motor_driver)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/er1_motor_driver
    DESTINATION ${geneus_INSTALL_DIR}
  )
endif()
add_dependencies(er1_motor_driver_generate_messages_eus std_msgs_generate_messages_eus)
